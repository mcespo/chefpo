...
description: A German pancake from America's Test Kitchen using a cold oven start for a custardy center and crispy sides.
...
<VideoFrame
  title="German Pancakes (Dutch Baby), America's Test Kitchen"
